            ...
            <div className='authormain_div'>
                <div className='maincontentdiv'>
                    <div className='authorimg_mob'>
                        <img src="https://neokred.s3.ap-south-1.amazonaws.com/About-us/ceo.png" alt='image' />
                    </div>
                    <div className='authorimg'>
                        <img src="https://neokred.s3.ap-south-1.amazonaws.com/About-us/ceo.png" alt='image' />
                    </div>
                    <div className='authorheading'>
                        <h1 className='authorheading_text'>Tarun Nazare</h1>
                        <div className='authorsecondheading'>
                            <h2 className='authorsecondheading_text'>CEO | Co-Founder</h2>
                        ...
                        <p className='authorsecondheading_subtext'>{`Leading Neokred as Co-founder and CEO, I am driven to chart its strategic course and cultivate a culture of collaborative leadership. Transforming vision into tangible results is deeply rewarding, and I am proud to serve as a cornerstone of our leadership team. Navigating the dynamic industry landscape and propelling Neokred towards continued growth and success presents both an honor and an ongoing challenge – one I wholeheartedly embrace.`}</p>
                    </div>
                </div>
